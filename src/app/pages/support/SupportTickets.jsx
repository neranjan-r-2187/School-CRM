                  ...
                  <div className="space-y-3">
                    ...
                    <Select value={newTicket.category} onValueChange={(value) => setNewTicket({ ...newTicket, category: value })}>
                      ...
                      <SelectContent className="rounded-2xl border border-slate-200 bg-white shadow-2xl p-2 z-[9999]">
                        <SelectItem value="Technical" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">Technical</SelectItem>
                        <SelectItem value="Academic" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">Academic</SelectItem>
                        <SelectItem value="Financial" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">Financial</SelectItem>
                        <SelectItem value="Administrative" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">Administrative</SelectItem>
                        <SelectItem value="Other" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">Other</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="space-y-3">
                    ...
                    <Select value={newTicket.priority} onValueChange={(value) => setNewTicket({ ...newTicket, priority: value })}>
                      ...
                      <SelectContent className="rounded-2xl border border-slate-200 bg-white shadow-2xl p-2 z-[9999]">
                        <SelectItem value="Low" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">Low Urgency</SelectItem>
                        <SelectItem value="Medium" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">Medium Urgency</SelectItem>
                        <SelectItem value="High" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50">High Urgency</SelectItem>
                        <SelectItem value="Urgent" className="rounded-xl font-bold py-3 cursor-pointer hover:bg-slate-50 text-rose-600">CRITICAL</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
